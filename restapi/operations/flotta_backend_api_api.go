...
func NewFlottaBackendAPIAPI(spec *loads.Document) *FlottaBackendAPIAPI {
	return &FlottaBackendAPIAPI{
		...
		FinalizeDeviceRegistrationHandler: FinalizeDeviceRegistrationHandlerFunc(func(params FinalizeDeviceRegistrationParams) middleware.Responder {
			return middleware.NotImplemented("operation FinalizeDeviceRegistration has not yet been implemented")
		}),
		...
		InitializeDeviceRegistrationHandler: InitializeDeviceRegistrationHandlerFunc(func(params InitializeDeviceRegistrationParams) middleware.Responder {
			return middleware.NotImplemented("operation InitializeDeviceRegistration has not yet been implemented")
		}),
		IsDeviceDeregistrableHandler: IsDeviceDeregistrableHandlerFunc(func(params IsDeviceDeregistrableParams) middleware.Responder {
			return middleware.NotImplemented("operation IsDeviceDeregistrable has not yet been implemented")
		}),
	}
}
...
type FlottaBackendAPIAPI struct {
	...
	// FinalizeDeviceRegistrationHandler sets the operation handler for the finalize device registration operation
	FinalizeDeviceRegistrationHandler FinalizeDeviceRegistrationHandler
	...
	// InitializeDeviceRegistrationHandler sets the operation handler for the initialize device registration operation
	InitializeDeviceRegistrationHandler InitializeDeviceRegistrationHandler
	// IsDeviceDeregistrableHandler sets the operation handler for the is device deregistrable operation
	IsDeviceDeregistrableHandler IsDeviceDeregistrableHandler
...
func (o *FlottaBackendAPIAPI) Validate() error {
	...
	if o.FinalizeDeviceRegistrationHandler == nil {
		unregistered = append(unregistered, "FinalizeDeviceRegistrationHandler")
	}
	if o.GetDeviceConfigurationHandler == nil {
		unregistered = append(unregistered, "GetDeviceConfigurationHandler")
	}
	if o.InitializeDeviceRegistrationHandler == nil {
		unregistered = append(unregistered, "InitializeDeviceRegistrationHandler")
	}
	if o.IsDeviceDeregistrableHandler == nil {
		unregistered = append(unregistered, "IsDeviceDeregistrableHandler")
	}
...
func (o *FlottaBackendAPIAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/namespaces/{namespace}/devices/{device-id}/enrol"] = NewEnrolDevice(o.context, o.EnrolDeviceHandler)
	if o.handlers["PUT"] == nil {
		o.handlers["PUT"] = make(map[string]http.Handler)
	}
	o.handlers["PUT"]["/namespaces/{namespace}/devices/{device-id}/register"] = NewFinalizeDeviceRegistration(o.context, o.FinalizeDeviceRegistrationHandler)
	...
	o.handlers["POST"]["/namespaces/{namespace}/devices/{device-id}/register"] = NewInitializeDeviceRegistration(o.context, o.InitializeDeviceRegistrationHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/namespaces/{namespace}/devices/{device-id}/deregister"] = NewIsDeviceDeregistrable(o.context, o.IsDeviceDeregistrableHandler)
}
