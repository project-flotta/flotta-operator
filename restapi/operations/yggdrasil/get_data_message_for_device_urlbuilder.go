...
func (o *GetDataMessageForDeviceURL) WithBasePath(bp string) *GetDataMessageForDeviceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetDataMessageForDeviceURL) Build() (*url.URL, error) {
	...
	var _path = "/data/{device_id}/in"

	deviceID := o.DeviceID
	if deviceID != "" {
		_path = strings.Replace(_path, "{device_id}", deviceID, -1)
	} else {
		return nil, errors.New("deviceId is required on GetDataMessageForDeviceURL")
	}
...
func (o *GetDataMessageForDeviceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetDataMessageForDeviceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetDataMessageForDeviceURL")
	}
