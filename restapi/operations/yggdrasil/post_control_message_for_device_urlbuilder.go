...
func (o *PostControlMessageForDeviceURL) WithBasePath(bp string) *PostControlMessageForDeviceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PostControlMessageForDeviceURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/control/{device_id}/out"

	deviceID := o.DeviceID
	if deviceID != "" {
		_path = strings.Replace(_path, "{device_id}", deviceID, -1)
	} else {
		return nil, errors.New("deviceId is required on PostControlMessageForDeviceURL")
	}
...
func (o *PostControlMessageForDeviceURL) String() string {
...
func (o *PostControlMessageForDeviceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostControlMessageForDeviceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostControlMessageForDeviceURL")
	}
