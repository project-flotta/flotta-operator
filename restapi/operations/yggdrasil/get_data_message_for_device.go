...
func (fn GetDataMessageForDeviceHandlerFunc) Handle(params GetDataMessageForDeviceParams) middleware.Responder {
	return fn(params)
}
...
func NewGetDataMessageForDevice(ctx *middleware.Context, handler GetDataMessageForDeviceHandler) *GetDataMessageForDevice {
	return &GetDataMessageForDevice{Context: ctx, Handler: handler}
}
...
func (o *GetDataMessageForDevice) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		r = rCtx
	}
	var Params = NewGetDataMessageForDeviceParams()
