...
// GetDataMessageForDeviceParams contains all the bound params for the get data message for device operation
...
func (o *GetDataMessageForDeviceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetDataMessageForDeviceParams) bindDeviceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
