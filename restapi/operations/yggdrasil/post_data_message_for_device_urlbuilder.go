...
func (o *PostDataMessageForDeviceURL) WithBasePath(bp string) *PostDataMessageForDeviceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PostDataMessageForDeviceURL) Build() (*url.URL, error) {
	...
	var _path = "/data/{device_id}/out"

	deviceID := o.DeviceID
	if deviceID != "" {
		_path = strings.Replace(_path, "{device_id}", deviceID, -1)
	} else {
		return nil, errors.New("deviceId is required on PostDataMessageForDeviceURL")
	}
...
func (o *PostDataMessageForDeviceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostDataMessageForDeviceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostDataMessageForDeviceURL")
	}
