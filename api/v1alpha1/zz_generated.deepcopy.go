...
func (in *AnsiblePlaybookCmd) DeepCopyInto(out *AnsiblePlaybookCmd) {
	*out = *in
	...
	if in.Options != nil {
		...
		*out = make(map[string]*AnsibleOptions, len(*in))
		for key, val := range *in {
			var outVal *AnsibleOptions
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
	...
	if in.PrivilegeEscalationOptions != nil {
		...
		*out = make(map[string]*PrivilegeEscalationOptions, len(*in))
		for key, val := range *in {
			var outVal *PrivilegeEscalationOptions
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
...
func (in *EdgeConfig) DeepCopyInto(out *EdgeConfig) {
	*out = *in
	...
	in.EdgePlaybook.DeepCopyInto(&out.EdgePlaybook)
}
