...
func (in *EdgeDeploymentSpec) DeepCopyInto(out *EdgeDeploymentSpec) {
	*out = *in
	...
	if in.ImageRepositories != nil {
		...
		*out = new(ImageRepositoriesConfiguration)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ImageRepositoriesConfiguration) DeepCopyInto(out *ImageRepositoriesConfiguration) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ImageRepositoriesConfiguration.
func (in *ImageRepositoriesConfiguration) DeepCopy() *ImageRepositoriesConfiguration {
	if in == nil {
		return nil
	}
	out := new(ImageRepositoriesConfiguration)
