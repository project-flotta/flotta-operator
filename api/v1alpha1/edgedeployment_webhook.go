...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-management-k4e-io-v1alpha1-edgedeployment,mutating=false,failurePolicy=fail,groups=management.k4e.io,resources=edgedeployments,versions=v1alpha1,name=edgedeploymnet.management.k4e.io,sideEffects=None,admissionReviewVersions=v1
