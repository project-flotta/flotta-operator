...
type mockConstructorTestingTNewMockBackendAPI interface {
	mock.TestingT
	Cleanup(func())
}

// NewMockBackendAPI creates a new instance of MockBackendAPI. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockBackendAPI(t mockConstructorTestingTNewMockBackendAPI) *MockBackendAPI {
	mock := &MockBackendAPI{}
	mock.Mock.Test(t)
