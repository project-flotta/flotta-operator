...
func (o *RegisterDeviceURL) Build() (*url.URL, error) {
	...
	if deviceID != "" {
		...
		return nil, errors.New("deviceId is required on RegisterDeviceURL")
	}
	...
	if namespace != "" {
		...
		return nil, errors.New("namespace is required on RegisterDeviceURL")
	}
...
func (o *RegisterDeviceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RegisterDeviceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RegisterDeviceURL")
	}
