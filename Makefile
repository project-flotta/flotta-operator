...
# project-flotta.io/k4e-operator-bundle:$VERSION and project-flotta.io/k4e-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= project-flotta.io/k4e-operator
