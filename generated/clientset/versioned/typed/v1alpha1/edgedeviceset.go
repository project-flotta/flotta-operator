...
// EdgeDeviceSetsGetter has a method to return a EdgeDeviceSetInterface.
...
// edgeDeviceSets implements EdgeDeviceSetInterface
type edgeDeviceSets struct {
	client rest.Interface
	ns     string
}

// newEdgeDeviceSets returns a EdgeDeviceSets
func newEdgeDeviceSets(c *ManagementV1alpha1Client, namespace string) *edgeDeviceSets {
	return &edgeDeviceSets{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *edgeDeviceSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EdgeDeviceSet, err error) {
	result = &v1alpha1.EdgeDeviceSet{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("edgedevicesets").
		Name(name).
...
func (c *edgeDeviceSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EdgeDeviceSetList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.EdgeDeviceSetList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("edgedevicesets").
...
func (c *edgeDeviceSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *edgeDeviceSets) Create(ctx context.Context, edgeDeviceSet *v1alpha1.EdgeDeviceSet, opts v1.CreateOptions) (result *v1alpha1.EdgeDeviceSet, err error) {
	result = &v1alpha1.EdgeDeviceSet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("edgedevicesets").
...
func (c *edgeDeviceSets) Update(ctx context.Context, edgeDeviceSet *v1alpha1.EdgeDeviceSet, opts v1.UpdateOptions) (result *v1alpha1.EdgeDeviceSet, err error) {
	result = &v1alpha1.EdgeDeviceSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("edgedevicesets").
		Name(edgeDeviceSet.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(edgeDeviceSet).
		Do(ctx).
		Into(result)
...
func (c *edgeDeviceSets) UpdateStatus(ctx context.Context, edgeDeviceSet *v1alpha1.EdgeDeviceSet, opts v1.UpdateOptions) (result *v1alpha1.EdgeDeviceSet, err error) {
	result = &v1alpha1.EdgeDeviceSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("edgedevicesets").
...
func (c *edgeDeviceSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *edgeDeviceSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *edgeDeviceSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EdgeDeviceSet, err error) {
	result = &v1alpha1.EdgeDeviceSet{}
