...
import (
	...
	"github.com/project-flotta/flotta-operator/generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type ManagementV1alpha1Interface interface {
...
// NewForConfigAndClient creates a new ManagementV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ManagementV1alpha1Client, error) {
	...
	return &ManagementV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ManagementV1alpha1Client for the given config and
...
func New(c rest.Interface) *ManagementV1alpha1Client {
	return &ManagementV1alpha1Client{c}
}
