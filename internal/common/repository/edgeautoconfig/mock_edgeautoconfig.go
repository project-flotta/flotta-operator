...
// Source: github.com/project-flotta/flotta-operator/internal/common/repository/edgeautoconfig (interfaces: Repository)

// Package edgeautoconfig is a generated GoMock package.
...
func (m *MockRepository) Create(arg0 context.Context, arg1 *v1alpha1.EdgeAutoConfig) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Delete(arg0 context.Context, arg1 *v1alpha1.EdgeAutoConfig) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) PatchStatus(arg0 context.Context, arg1 *v1alpha1.EdgeAutoConfig, arg2 *client.Patch) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Read(arg0 context.Context, arg1, arg2 string) (*v1alpha1.EdgeAutoConfig, error) {
	m.ctrl.T.Helper()
...
// ReadNS mocks base method.
func (m *MockRepository) ReadNS(arg0 context.Context, arg1 string) (*v1alpha1.EdgeAutoConfig, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReadNS", arg0, arg1)
	ret0, _ := ret[0].(*v1alpha1.EdgeAutoConfig)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ReadNS indicates an expected call of ReadNS.
func (mr *MockRepositoryMockRecorder) ReadNS(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReadNS", reflect.TypeOf((*MockRepository)(nil).ReadNS), arg0, arg1)
}
