...
// Source: github.com/project-flotta/flotta-operator/internal/common/repository/edgeconfig (interfaces: Repository)

// Package edgeconfig is a generated GoMock package.
package edgeconfig
...
func (m *MockRepository) ListByLabel(arg0 context.Context, arg1, arg2, arg3 string) ([]v1alpha1.EdgeConfig, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListByLabel", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].([]v1alpha1.EdgeConfig)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepository) Patch(arg0 context.Context, arg1, arg2 *v1alpha1.EdgeConfig) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Read(arg0 context.Context, arg1, arg2 string) (*v1alpha1.EdgeConfig, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) RemoveFinalizer(arg0 context.Context, arg1 *v1alpha1.EdgeConfig, arg2 string) error {
	m.ctrl.T.Helper()
