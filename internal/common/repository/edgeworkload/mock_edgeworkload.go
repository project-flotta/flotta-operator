...
// Source: github.com/project-flotta/flotta-operator/internal/common/repository/edgeworkload (interfaces: Repository)
...
func (m *MockRepository) Create(arg0 context.Context, arg1 *v1alpha1.EdgeWorkload) error {
	m.ctrl.T.Helper()
